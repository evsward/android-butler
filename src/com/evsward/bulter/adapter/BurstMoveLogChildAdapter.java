...
public class BurstMoveLogChildAdapter extends BaseAdapter {
	private Context mContext;
	private LayoutInflater mInflater;
	private List<CompetitionHistoryLog> logList;

	public BurstMoveLogChildAdapter(Context context, List<CompetitionHistoryLog> logList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (BurstMoveLogAdapter.burstMovedtableNOChoosed == logInfo.getLogID()) {
